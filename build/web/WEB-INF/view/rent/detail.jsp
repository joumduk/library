                ...
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <div class="row form-group">
                          ...
                          <div class="col-12 col-md-9"><input type="text"  class="form-control" disabled="" value="${rent.rentDate.getDate()}/${rent.rentDate.getMonth()}/${rent.rentDate.getYear()}"><small class="form-text text-muted"></small></div>
                        </div>
                    
                        <div class="row form-group">
                          <div class="col col-md-3"><label  class=" form-control-label">Return Date</label></div>
                          <div class="col-12 col-md-9"><input type="text" class="form-control" disabled="" value="${rent.expireDate.getDate()}/${rent.expireDate.getMonth()}/${rent.expireDate.getYear()}"><small class="form-text text-muted"></small></div>
                        </div>
                    </div>
                    </form>
                </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <c:forEach var="item" items="${items}" varStatus="iter">
                                 <tr>
                                    ...
                                    <td>${item.bookName}</td>
                                    <td>${item.quantity}</td>
                                    <td><c:if test="${!item.status}"><A class="btn btn-link" href="return?${item.idBook}">Return</A></c:if></td>
                                </tr>
                            </c:forEach>
                        </table>
